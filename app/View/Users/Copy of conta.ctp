			...
			<div class="row mt20">
				<div id="tabs" class="row nav-tabs-estabelecimentos">
					<ul class="row">
						...
						<a class="link-tab" href="/users/edit">Alterar minha senha</a>
						<!--<a class="link-tab" href="/users/preferencias">Editar minhas referências</a>-->
							...
							<div class="row">
								<div id="tabs-1">
									<div class="row">
										...
										<div class=" mt10">
											<label>
												<small>(Deixe em branco para não alterar)</small><?= $this->Form->input('image',array('class'=>'imagem-editar-perfil','type'=>'file','value'=>'null'))?> 
												<?= $this->Form->input('image_hidden',array('class'=>'span4','type'=>'hidden','value'=>$this->data['User']['image']))?>
											</label>
										</div>											
										<div class="row mt10">
