(function ($) {
    $.fn.county = function (options) {
        ...
        return this.each(function () {
            ...
            container.append('<span class="county-days-wrapper first"><span class="county-days">0</span></span><span class="county-hours-wrapper separator-left border-separator-right"><span class="county-hours">00</span></span><span class="divisao-hora">:</span><span class="county-minutes-wrapper separator-left separator-left"><span class="county-minutes">00</span></span><span class="divisao-hora">:</span><span class="county-seconds-wrapper separator-left last"><span class="county-seconds">00</span></span><div class="clear"></div><span class="county-label-days">Dias</span><span class="county-label-hours">Horas</span><span class="county-label-minutes">Minutes</span><span class="county-label-seconds">Segundos</span>');
