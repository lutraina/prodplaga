							...
							<div class="row">
								<div id="tabs-1">
									<div class="row">
										...
										<div class="mt10">
											<label>
												  <?= $this->Form->input('image',array('id'=>'imagem', 'class'=>'imagem-editar-perfil','type'=>'file'))?>
												  <?= $this->Form->input('image_hidden',array('id'=>'imagem', 'class'=>'imagem-editar-perfil','type'=>'hidden','value'=>$this->data['User']['image']))?>
											</label>
										</div><br /><br />										
										<div class="row mt10">
