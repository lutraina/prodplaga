								...
								<div id="tabs-1">
									<div class="row">
										...
										<div class="row mt10">
											...
											<div class="six columns">
												<?= $this->Form->input('password_confirmation',array('id'=>'cadastro_email', 'placeholder'=>'CONFIRME SUA SENHA'))?>
											</div>
										</div>										
										<div class="row mt10">
										 	...
										 	<?php foreach($interesses as $interesse): ?>
												<li class="field">
													<label class="checkbox checked" for="check1">
														<input name="data[User][interesse][]" id="check1" value="<?= $interesse['Interesse']['id']?>" type="checkbox" checked="checked">
